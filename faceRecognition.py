...
def faceDetection(test_img):
    ...
    face_haar_cascade=cv2.CascadeClassifier('/home/siva_ganesh/zips/projects/AttendanceSystem/haarcascade_frontalface_default.xml')#Load haar classifier
...
def put_text(test_img,text,x,y):
    cv2.putText(test_img,text,(x-40,y-40),cv2.FONT_HERSHEY_DUPLEX,2,255)
